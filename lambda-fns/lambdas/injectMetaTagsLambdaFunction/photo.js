...
exports.handler = async (event, context, callback) => {
  ...
  const body = index
    .replace(
      ...
      <link rel="preload" href="https://img.wisaw.com/${imageId}-thumb" as="image" fetchpriority="high" />
      <link rel="preload" href="https://img.wisaw.com/${imageId}" as="image" fetchpriority="high" />
      `,
    )
