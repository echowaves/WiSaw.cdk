...
- [x] 2.1 Create `.github/instructions/db-migrations.instructions.md` with frontmatter `applyTo: 'migrations/**'` that summarizes the key conventions as concise rules for AI agents generating migration code
