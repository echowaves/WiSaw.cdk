...
Define permission rules for photo mutations (comments) based on wave ownership and freeze state, allowing owners and facilitators to manage content in their own frozen waves.
